        ...
        <section className="py-16 px-4 bg-white">
            <div className="max-w-6xl mx-auto">
                <div className="bg-[#067E48] rounded-3xl px-8 py-16 md:py-24 text-center ">
                    {/* Heading */}
                    <span className="text-2xl md:text-4xl lg:text-6xl  text-white text-[56px] leading-[1.2] font-bold mb-6">
                    ...
                    {/* Subtitle */}
                    <p className="text-[16px] leading-[1.5]  md:text-xl text-green-50 mb-10 max-w-2xl mx-auto">
                        Be part of Africa's fastest-growing digital trade ecosystem. Together we can make intra-African
                        trade simpler, smarter and more inclusive.
                    </p>
